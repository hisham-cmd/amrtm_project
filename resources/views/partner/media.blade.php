...
@section('sidebar-nav')
    ...
    <a href="{{ route('partner.media') }}" class="nav-item active">
...
<div class="section-card mb-5">
    ...
    <form method="POST" action="{{ route('partner.media.upload') }}" enctype="multipart/form-data" class="p-5">
        @csrf
    ...
    <div class="p-5">
        ...
        <div class="grid gap-4" style="grid-template-columns: repeat(auto-fill, minmax(160px, 1fr))">
            ...
            <div class="relative group rounded-xl overflow-hidden border border-gray-200 shadow-sm">
                <img src="{{ $img->url }}" alt="صورة" class="w-full h-36 object-cover">
                <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <form method="POST" action="{{ route('partner.media.delete', $img->id) }}"
