...
@section('sidebar-nav')
    <a href="{{ route('partner.application-pending') }}" class="nav-item active">
...
<div style="max-width:640px; margin:60px auto; text-align:center;">
    ...
    <h2 style="font-size:1.6rem;font-weight:800;color:#0f3d24;margin-bottom:12px;">بروفايلك قيد المراجعة</h2>
    <p style="color:#6c7a72;font-size:14px;line-height:1.8;max-width:480px;margin:0 auto;">
        تم استلام بيانات بروفايلك وهو حالياً قيد المراجعة من قِبَل فريقنا.<br>
