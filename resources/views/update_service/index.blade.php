...
/* About-One Section */
.about-one-wrap{width:100%;max-width:1400px;margin:0 auto;padding:30px 40px 20px;display:flex;align-items:center;gap:24px;position:relative;z-index:2;overflow:hidden;background:rgba(255,255,255,.75);border-radius:20px 20px 0 0;margin-top:100px}
...
/* Offices */
.offices-sec{padding:16px 40px 12px!important;position:relative!important;overflow:hidden!important;background:rgba(255,255,255,.75)!important;border-radius:0 0 16px 16px!important;max-width:1400px!important;    margin: 0px auto !important;}
