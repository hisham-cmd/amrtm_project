...
========================= */
        ...
        body.en .hero-slider-arrow.prev {
            right: auto;
            left: 20px
        }

        body.en .hero-slider-arrow.next {
            left: auto;
            right: 20px
        }
...
========================= */
        ...
        .offices-hd .s-bar {
            background: linear-gradient(90deg, rgba(255, 255, 255, .7), rgba(255, 255, 255, 0.53))
        }
...
========================= */
        ...
        @keyframes vid-pulse {
            ...
            0%,
            100% {
                box-shadow: 0 8px 24px rgba(0, 108, 53, .45);
            }

            50% {
                box-shadow: 0 8px 32px rgba(0, 108, 53, .7), 0 0 0 10px rgba(0, 108, 53, .1);
            }
        }
...
=========================== */
   ...
   ========================================== */
        ...
        .about-one__img {
            ...
            border-radius: 24px;
            overflow: hidden;
            box-shadow: 0 20px 60px rgba(0, 108, 53, .15);
            position: relative;
            z-index: 2
        }
        ...
        .about-one__video-icon {
            ...
            cursor: pointer;
            transition: .3s;
            box-shadow: 0 8px 25px rgba(0, 108, 53, .3);
            position: relative
        }
        ...
        .about-one__call-box {
            ...
            border-radius: 14px;
            padding: 10px 16px;
            box-shadow: 0 8px 30px rgba(0, 108, 53, .12);
            border: 1px solid rgba(0, 108, 53, .08)
        }
        ...
        .ao-card {
            ...
            backdrop-filter: blur(2px) saturate(160%) !important;
            border: 1.5px solid rgba(255, 255, 255, 0.45) !important;
            border-top: 4px solid var(--cc, #00A651) !important;
            box-shadow: 0 10px 30px rgba(0, 0, 0, 0.28), inset 0 1px 1px rgba(255, 255, 255, 0.6) !important;
        ...
        .ao-card:hover {
            ...
            background: linear-gradient(135deg, rgba(255, 255, 255, 0.32) 0%, rgba(255, 255, 255, 0.14) 100%) !important;
            border-color: rgba(255, 255, 255, 0.8) !important;
            border-top-color: var(--cc, #00A651) !important;
            box-shadow: 0 18px 42px rgba(0, 0, 0, 0.38), 0 0 20px rgba(255, 255, 255, 0.2), inset 0 1px 2px rgba(255, 255, 255, 0.8) !important;
        }
        ...
        .ao-card-ico {
            ...
            box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2), inset 0 1px 1px rgba(255, 255, 255, 0.6) !important;
            backdrop-filter: blur(8px) !important;
            transition: transform .3s ease !important;
        }

        .ao-card:hover .ao-card-ico {
        ...
        .ao-card-nm {
            ...
            color: #ffffff !important;
            text-shadow: 0 2px 8px rgba(0, 0, 0, 0.75), 0 1px 2px rgba(0, 0, 0, 0.95) !important;
        ...
        .ao-card-foot {
            ...
            background: rgba(0, 20, 10, 0.38) !important;
        ...
        .ao-card:hover .ao-card-arr {
            transform: translateX(-4px) !important;
        }

        body.en .ao-card:hover .ao-card-arr {
            transform: translateX(4px) !important;
        }
        ...
        .about-one__btn {
            ...
            text-decoration: none;
            transition: .3s;
            box-shadow: 0 6px 20px rgba(0, 108, 53, .25)
        }

        .about-one__btn:hover {
            transform: translateY(-3px);
            box-shadow: 0 10px 30px rgba(0, 108, 53, .35)
        }
        ...
        .cards-grid .card {
            ...
            border: 1px solid rgba(0, 108, 53, .08) !important;
            box-shadow: 0 4px 15px rgba(0, 108, 53, .08) !important;
            cursor: pointer !important;
        ...
        .cards-grid .card:hover {
            ...
            box-shadow: 0 12px 30px rgba(0, 108, 53, .15) !important;
        ...
        .cards-grid .card-foot {
            display: flex !important;
            align-items: center !important;
            justify-content: space-between !important;
            padding: 6px 12px !important;
            border-top: 1px solid rgba(0, 108, 53, .06) !important;
        ...
        .s-ttl {
            font-size: clamp(.7rem, 1.4vw, .85rem) !important;
            font-weight: 800 !important;
            color: #fff !important;
        ...
        .off-card {
            ...
            text-decoration: none !important;
            color: #002A15 !important;
            box-shadow: 0 1px 4px rgba(0, 108, 53, .05) !important
        }

        .off-card:hover {
            transform: translateY(-2px) !important;
            box-shadow: 0 4px 12px rgba(0, 108, 53, .1) !important;
            border-color: #00843D !important
        }
...
<body class="ar">
    ...
    <nav class="nb">
        <a class="nb-logo" href="{{ route('amrtm.index') }}">
            <div class="nb-logo-img">
                <img src="data:image/png;base64,"
                    alt="آمر تم"
                    onerror="this.style.display='none';this.parentElement.innerHTML+='<svg viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'rgba(255,255,255,0.9)\' stroke-width=\'2.2\' width=\'20\' height=\'20\'><path d=\'M12 2L2 7l10 5 10-5-10-5z\'/><path d=\'M2 17l10 5 10-5\'/><path d=\'M2 12l10 5 10-5\'/></svg>'" />
            </div>
        ...
        <div class="nb-right">
            ...
            <div id="nb-guest"
                style="{{ auth('business')->check() ? 'display:none' : 'display:flex' }};gap:6px;align-items:center;">
                <a class="nb-btn out" href="{{ route('amrtm.login') }}" id="nb-li"><i
                        class="fa fa-right-to-bracket"></i><span id="nl-li">دخول</span></a>
                <a class="nb-btn sol" href="{{ route('amrtm.register') }}" id="nb-re"><i
                        class="fa fa-user-plus"></i><span id="nl-re">تسجيل</span></a>
                <a href="{{ route('amrtm.office.login') }}"
                    style="display:flex;align-items:center;gap:5px;padding:7px 13px;border-radius:20px;background:rgba(255,255,255,.12);color:#fff;font-size:12.5px;font-weight:700;text-decoration:none;border:1px solid rgba(255,255,255,.25);transition:.2s;white-space:nowrap"
            ...
            <div id="nb-auth"
                style="{{ auth('business')->check() ? 'display:flex' : 'display:none' }};gap:6px;align-items:center;">
                @auth('business')
                    ...
                    <form id="nb-logout-form" method="POST" action="{{ route('amrtm.logout') }}" style="display:none;">@csrf
                    </form>
    ...
    <div class="mob-dd" id="mob-dd">
        ...
        <div class="mob-lnk" onclick="scrollCards();clsMob()"><i class="fa fa-table-cells-large"></i><span
                id="mn-s">الخدمات</span></div>
        @auth('business')
            @if(auth('business')->user()->isAdmin())
                <div class="mob-lnk" onclick="location.href='{{ route('amrtm.admin.dashboard') }}'"><i
                        class="fa fa-gauge-high"></i><span>لوحة التحكم</span></div>
            @else
                <div class="mob-lnk" onclick="location.href='{{ route('amrtm.user.dashboard') }}'"><i
                        class="fa fa-gauge-high"></i><span>حسابي</span></div>
            @endif
            <div class="mob-lnk" onclick="document.getElementById('mob-logout-form').submit()"><i
                    class="fa fa-right-from-bracket"></i><span>تسجيل الخروج</span></div>
            <form id="mob-logout-form" method="POST" action="{{ route('amrtm.logout') }}" style="display:none;">@csrf</form>
        @else
            <div class="mob-lnk" onclick="location.href='{{ route('amrtm.login') }}'"><i
                    class="fa fa-right-to-bracket"></i><span id="mn-l">تسجيل الدخول</span></div>
            <div class="mob-lnk" onclick="location.href='{{ route('amrtm.register') }}'"><i
                    class="fa fa-user-plus"></i><span id="mn-r">إنشاء حساب</span></div>
        @endauth
    </div>
    ...
    <section class="hero">
                ...
                <div class="about-one__img-box">
                    ...
                    <div class="about-one__img" onclick="openVid()"
                        ...
                        <div class="about-one__video-link"
                            style="position:absolute; top:42%; left:50%; transform:translate(-50%,-50%); z-index:3; pointer-events:auto;">
                        ...
                        <div class="about-one__video-label"
                            style="position:absolute; bottom:10px; left:8px; right:8px; z-index:3; text-align:center; background:rgba(0,0,0,0.48); backdrop-filter:blur(8px); -webkit-backdrop-filter:blur(8px); padding:6px 8px; border-radius:12px; border:1px solid rgba(255,255,255,0.2); pointer-events:none;">
                            <span
                                style="color:#ffffff; font-size:12px; font-weight:700; display:flex; align-items:center; justify-content:center; gap:6px;">
        ...
        <div class="offices-sec" id="offices-sec">
            <div class="offices-inner">
                <div class="s-ttl" id="off-ttl">مكاتب المستشارين والشركات المهنية المتخصصة المساندة لتقديم الخدمات
                    لعملاء منصة أمر تم</div>
                <div class="off-cards-grid">
                    <a href="{{ route('amrtm.offices.directory', 'law') }}" class="off-card" id="off-card-law">
                        <div class="off-card-icon" style="background:linear-gradient(135deg,#006C35,#006C35)"><i
                                class="fa fa-scale-balanced"></i></div>
                        <div class="off-card-body">
                            <div class="off-card-name" id="off-name-law">مكاتب المحاماة</div>
                        </div>
                    </a>
                    <a href="{{ route('amrtm.offices.directory', 'services') }}" class="off-card" id="off-card-svc">
                        <div class="off-card-icon" style="background:linear-gradient(135deg,#bd15c0,#c71ee5)"><i
                                class="fa fa-briefcase"></i></div>
                        <div class="off-card-body">
                            <div class="off-card-name" id="off-name-svc">مكاتب الخدمات والتعقيب</div>
                        </div>
                    </a>
                    <a href="{{ route('amrtm.offices.directory', 'customs') }}" class="off-card" id="off-card-cus">
                        <div class="off-card-icon" style="background:linear-gradient(135deg,#2182f0,#0688eb)"><i
                                class="fa fa-address-book"></i></div>
                        <div class="off-card-body">
                            <div class="off-card-name" id="off-name-cus">شركات التخليص الجمركي</div>
                        </div>
                    </a>
                    <a href="{{ route('amrtm.offices.directory', 'accounting') }}" class="off-card" id="off-card-acc">
                        <div class="off-card-icon" style="background:linear-gradient(135deg,#2207a7,#0b05d1)"><i
                                class="fa fa-calculator"></i></div>
                        <div class="off-card-body">
                            <div class="off-card-name" id="off-name-acc">الاستشارات المالية والضريبية</div>
                        </div>
                    </a>
                    <a href="{{ route('amrtm.offices.directory', 'engineering') }}" class="off-card" id="off-card-eng">
                        <div class="off-card-icon" style="background:linear-gradient(135deg,#f69d03,#e9a403)"><i
                                class="fa fa-building"></i></div>
                        <div class="off-card-body">
                            <div class="off-card-name" id="off-name-eng">الاستشارات الهندسية</div>
                        </div>
                    </a>
                    <a href="{{ route('amrtm.offices.directory', 'freelance') }}" class="off-card" id="off-card-free">
                        <div class="off-card-icon" style="background:linear-gradient(135deg,#00695C,#00897B)"><i
                                class="fa fa-user"></i></div>
                        <div class="off-card-body">
                            <div class="off-card-name" id="off-name-free">أصحاب المهن الحرة</div>
                        </div>
                    </a>
                </div>
    ...
    <div class="em" id="lgm" onclick="if(event.target===this)closeLgm()" style="z-index:700;">
        <div class="em-box" style="max-width:440px;">
            <div class="em-hd" style="background:linear-gradient(135deg,#006C35,#00843D);">
                ...
                <div>
                    <div class="em-hd-nm" id="lgm-ttl">تسجيل الدخول مطلوب</div>
                    <div class="em-hd-sb" id="lgm-sub">يجب تسجيل الدخول لتقديم طلب خدمة</div>
                </div>
                <button class="em-x" onclick="closeLgm()"><i class="fa fa-xmark"></i></button>
            </div>
            <div style="padding:2rem 1.6rem;text-align:center;">
                <div
                    style="width:72px;height:72px;border-radius:50%;background:rgba(0,108,53,.1);border:2px solid rgba(0,108,53,.15);display:flex;align-items:center;justify-content:center;margin:0 auto 1.2rem;font-size:30px;color:#006C35;">
                    <i class="fa fa-circle-user"></i>
                </div>
                <p style="font-size:14px;color:#004D28;line-height:1.8;margin-bottom:1.6rem;" id="lgm-body">لتقديم طلب
                    خدمة يجب أن يكون لديك حساب مسجل في المنصة. سجّل دخولك أو أنشئ حساباً جديداً مجاناً.</p>
                <div style="display:flex;flex-direction:column;gap:.75rem;">
                    <a id="lgm-login-btn" href="#"
                        style="display:flex;align-items:center;justify-content:center;gap:8px;height:48px;border-radius:12px;background:linear-gradient(135deg,#006C35,#00843D);color:#fff;font-family:inherit;font-size:14.5px;font-weight:800;text-decoration:none;transition:opacity .2s;"
                        onmouseover="this.style.opacity='.88'" onmouseout="this.style.opacity='1'"><i
                            class="fa fa-right-to-bracket"></i> <span id="lgm-login-lbl">تسجيل الدخول</span></a>
                    <a id="lgm-reg-btn" href="#"
                        style="display:flex;align-items:center;justify-content:center;gap:8px;height:48px;border-radius:12px;background:transparent;color:#006C35;font-family:inherit;font-size:14px;font-weight:700;text-decoration:none;border:1.5px solid rgba(0,108,53,.2);transition:background .2s;"
                        onmouseover="this.style.background='rgba(0,108,53,.06)'"
                        onmouseout="this.style.background='transparent'"><i class="fa fa-user-plus"></i> <span
                            id="lgm-reg-lbl">إنشاء حساب جديد</span></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="em" id="em" onclick="if(event.target===this)closeEm()">
        <div class="em-box">
            <div class="em-hd">
                ...
                <div>
                    <div class="em-hd-nm" id="em-nm">—</div>
                    <div class="em-hd-sb" id="em-sb">اختر الجهة</div>
                </div>
    ...
    <div class="fm" id="fm" onclick="if(event.target===this)closeFm()">
        <div class="fm-box">
            <div class="fm-hd">
                ...
                <div style="flex:1;">
                    <div class="fm-hd-nm" id="fm-hnm">استمارة التقديم</div>
                    <div class="fm-hd-sb" id="fm-hsb">يرجى تعبئة البيانات بدقة</div>
                </div>
            ...
            <div class="fm-sbar" id="fm-sb">
                ...
                <div style="flex:1;">
                    <div class="fm-snm" id="fm-snm">—</div>
                    <div class="fm-scat" id="fm-scat">—</div>
                </div>
                <div class="fm-sprice" id="fm-sp">—</div>
            </div>
            <!-- Balance -->
            <div class="fm-bal"><span class="fm-bal-lbl" id="fm-bl">رصيدك:</span><span class="fm-bal-val"
                    id="fm-bv">—</span></div>
            <!-- Success -->
            <div class="succ" id="fm-succ">
                ...
                <div class="succ-btns">
                    <a class="s-b1" href="{{ route('amrtm.user.dashboard') }}" id="sc-d"><i
                            class="fa fa-gauge-high"></i><span id="sc-dl">تابع طلبك</span></a>
            ...
            <div class="fm-body" id="fm-in">
                ...
                <div class="fm-row">
                    <div class="fld"><label><span class="req">*</span><span id="ln">الاسم الكامل</span></label><input
                            type="text" id="fn" />
                        <div class="ferr" id="en"><i class="fa fa-circle-exclamation"></i><span id="ent">مطلوب</span>
                        </div>
                    </div>
                    <div class="fld"><label><span class="req">*</span><span id="lid">رقم الهوية</span></label><input
                            type="text" id="fid" maxlength="10" />
                        <div class="ferr" id="eid"><i class="fa fa-circle-exclamation"></i><span id="eidt">غير
                                صحيح</span></div>
                    </div>
                </div>
                <div class="fm-row">
                    <div class="fld"><label><span class="req">*</span><span id="lph">رقم الجوال</span></label><input
                            type="tel" id="fph" />
                        <div class="ferr" id="eph"><i class="fa fa-circle-exclamation"></i><span id="epht">غير
                                صحيح</span></div>
                    </div>
                    <div class="fld"><label><span class="req">*</span><span id="lem">البريد
                                الإلكتروني</span></label><input type="email" id="fem" />
                        <div class="ferr" id="eem"><i class="fa fa-circle-exclamation"></i><span id="eemt">غير
                                صحيح</span></div>
                    </div>
                </div>
                <div class="fm-sec-lbl" style="margin-top:.4rem"><i class="fa fa-building"></i><span
                        id="fm-lbl-biz">بيانات الجهة (اختياري)</span></div>
                <div class="fm-row">
                    <div class="fld"><label><span id="lco">اسم الشركة</span></label><input type="text" id="fco" /></div>
                    <div class="fld"><label><span id="lcr">السجل التجاري</span></label><input type="text" id="fcr" />
                    </div>
                </div>
                <div class="fm-sec-lbl" style="margin-top:.4rem"><i class="fa fa-paperclip"></i><span
                        id="fm-lbl-attach">المرفقات والملاحظات</span></div>
                ...
                <div class="prv"><i class="fa fa-shield-halved"></i><span id="prv-t">بياناتك محمية ومشفرة ولن تُشارَك مع
                        أي جهة خارجية دون موافقتك الصريحة.</span></div>
    ...
    <footer class="footer">
        ...
        <div class="f-main">
            ...
            <!-- السوشيال -->
            <div class="f-soc">
                <a class="fsoc" href="https://x.com/amrtmcomsa" target="_blank" rel="noopener noreferrer"
                    aria-label="X">
                    <i class="fa fa-x-twitter"></i>
                </a>

                <a class="fsoc" href="https://www.linkedin.com/in/amrtm-com-sa/" target="_blank"
                    rel="noopener noreferrer" aria-label="LinkedIn">
                    <i class="fa fa-linkedin"></i>
                </a>

                <a class="fsoc" href="https://www.instagram.com/amrtm.com.sa/" target="_blank" rel="noopener noreferrer"
    ...
    <script>
        ...
        /* ══ RENDER CARDS ══ */
        function renderCards(list = cats) {
            const t = T[lang],
