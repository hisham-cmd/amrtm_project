...
<title>منصة آمر تم | Amrtm Platform</title>
...
.card:hover{
    ...
    border-color:rgba(206, 206, 206, 0.41);
}
.card:hover .card-nm{
    color:#1A237E;
    text-shadow:none;
...
.offices-sec{
  ...
  padding:3.5rem 2rem;
    ...
    background:
        linear-gradient(rgb(13 29 73 / 97%),rgba(171, 172, 173, 0.8)),
        url('/images/ghjhy.gpg.png');
...
.off-card:hover{
    ...
    border-color:rgba(206,206,206,.50);
...
.off-card-icon i{color:#fff;font-size:20px}
...
.f-lic{
  ...
  height:36px;
  border-radius:9px;
  border:1.5px solid rgba(13,18,87,.18);
  background:rgba(13,18,87,.06);
  display:flex;
  align-items:center;
  justify-content:center;
  overflow:hidden;
...
.fsoc{
  ...
  height:33px;
  border-radius:8px;
  border:1px solid rgba(13,18,87,.18);
  background:rgba(13,18,87,.06);
  display:flex;
  align-items:center;
  justify-content:center;
...
.f-ct{
  ...
  margin-bottom:1rem;
  padding-bottom:.5rem;
  border-bottom:1px solid rgba(13,18,87,.18);
...
@media(max-width:580px){
  ...
  .vid-fab{
    ...
    animation:vid-pulse 2.5s infinite;
  }
...
<section class="hero">
    ...
    <div class="-heroin">
        ...
        <div class="hero-text" style="text-align:center">
            ...
            <h1 id="h-t">
                منصة <span id="h-hl">آمر تم</span>
            </h1>

            <p class="h-desc" id="h-d">
                منصة موحدة تُنجز خدمات الأفراد وقطاع الأعمال عبر تكامل رقمي آمن وفعّال
            </p>
    ...
    <div class="cards-wrap-home">
        ...
        <div class="s-eye" id="s-eye" style="color:white">
            اختر القطاع
        </div>

        <div class="s-ttl" id="s-ttl" style="color:white">
            ابدأ بطلب خدمتك
        </div>
...
<!-- ================= OFFICES ================= -->
<section class="offices-sec" id="offices-sec">
    ...
    <div class="offices-inner">
        ...
        <div class="offices-hd">
            ...
            <div class="s-ttl" id="">
             المكاتب والشركات المساندة لمنصة امر تم لخدمات الاعمال
            </div>
    ...
    <a href="{{ route('amrtm.offices.directory', 'law') }}" class="off-card" id="off-card-law">
        ...
        <div class="off-card-body">
            ...
            <div class="off-card-desc" id="off-desc-law">
                استشارات قانونية وتمثيل أمام الجهات القضائية
            </div>
        </div>

        <div class="off-card-foot">
            <div class="off-card-count">
                <span class="off-cnt" id="off-cnt-law">0</span>
                <span id="off-cnt-lbl-law"style="color:white">مكتب معتمد</span>
            </div>

            <div class="off-card-arrow">
    ...
    <a href="{{ route('amrtm.offices.directory', 'services') }}" class="off-card" id="off-card-svc">
        ...
        <div class="off-card-body">
            ...
            <div class="off-card-desc" id="off-desc-svc">
                إنهاء المعاملات الحكومية والرسمية بكل سهولة
            </div>
        </div>

        <div class="off-card-foot">
            <div class="off-card-count">
                <span class="off-cnt" id="off-cnt-svc">0</span>
                <span id="off-cnt-lbl-svc"style="color:white">مكتب معتمد</span>
            </div>
    ...
    <a href="{{ route('amrtm.offices.directory', 'customs') }}" class="off-card" id="off-card-cus">
        ...
        <div class="off-card-body">
            ...
            <div class="off-card-desc" id="off-desc-cus">
                تخليص البضائع وإجراءات الاستيراد والتصدير
            </div>
        </div>

        <div class="off-card-foot">
            <div class="off-card-count">
                <span class="off-cnt" id="off-cnt-cus">0</span>
                <span id="off-cnt-lbl-cus"style="color:white">مكتب معتمد</span>
            </div>
    ...
    <a href="{{ route('amrtm.offices.directory', 'accounting') }}" class="off-card" id="off-card-acc">
        ...
        <div class="off-card-body">
            <div class="off-card-name" id="off-name-acc">
                مكاتب المحاسبة والاستشارات المالية والضريبية
            </div>

            <div class="off-card-desc" id="off-desc-acc">
                خدمات المحاسبة والاستشارات المالية والضريبية
            </div>
        </div>

        <div class="off-card-foot">
            <div class="off-card-count">
                <span class="off-cnt" id="off-cnt-acc">0</span>
                <span id="off-cnt-lbl-acc" style="color:white">مكتب معتمد</span>
            </div>
    ...
    <a href="{{ route('amrtm.offices.directory', 'engineering') }}" class="off-card" id="off-card-eng">
        ...
        <div class="off-card-body">
            <div class="off-card-name" id="off-name-eng">
                الاستشارات الهندسية والتصميم والإشراف
            </div>

            <div class="off-card-desc" id="off-desc-eng">
                التصميم الهندسي والإشراف وإدارة المشاريع
            </div>
        </div>

        <div class="off-card-foot">
            <div class="off-card-count">
                <span class="off-cnt" id="off-cnt-eng">0</span>
                <span id="off-cnt-lbl-eng"style="color:white">مكتب معتمد</span>
            </div>
    ...
    <a href="{{ route('amrtm.offices.directory', 'freelance') }}" class="off-card" id="off-card-free">
        ...
        <div class="off-card-body">
            ...
            <div class="off-card-desc" id="off-desc-free">
                خبراء ومستشارون يقدمون خدمات احترافية مستقلة
            </div>
        </div>

        <div class="off-card-foot">
            <div class="off-card-count">
                <span class="off-cnt" id="off-cnt-free">0</span>
                <span id="off-cnt-lbl-free"style="color:white">مكتب معتمد</span>
            </div>
...
<footer class="footer">
  <div class="f-main">
    <div>
      <div class="f-lr"><div class="f-lic"><img src="data:image/png;base64," alt="" onerror="this.style.display='none'"/></div><div><div class="f-lnm" id="fnm">آمر تم</div><div class="f-lsb" id="fsb">لقطاع الأعمال</div></div></div>
      <p class="f-ab" id="fab">منصة إلكترونية متكاملة لخدمة الأفراد وقطاع الأعمال، تُمكّنكم من إنجاز الخدمات الحكومية بسهولة وسرعة وأمان.</p>
      <div class="f-soc"><a class="fsoc" href="#"><i class="ti ti-brand-x"></i></a><a class="fsoc" href="#"><i class="ti ti-brand-linkedin"></i></a><a class="fsoc" href="#"><i class="ti ti-brand-instagram"></i></a><a class="fsoc" href="https://wa.me/966504915222"><i class="ti ti-brand-whatsapp"></i></a></div>
    </div>
    <div>
      <div class="f-ct" id="flt">روابط سريعة</div>
      <div class="f-ls">
        <a class="f-lk" href="{{ route('amrtm.index') }}"><i class="ti ti-chevron-left"></i><span id="fl-h">الرئيسية</span></a>
        <a class="f-lk" href="{{ route('login') }}"><i class="ti ti-chevron-left"></i><span id="fl-l">تسجيل الدخول</span></a>
        <a class="f-lk" href="{{ route('register') }}"><i class="ti ti-chevron-left"></i><span id="fl-r">إنشاء حساب</span></a>
        <a class="f-lk" href="{{ route('amrtm.user.dashboard') }}"><i class="ti ti-chevron-left"></i><span id="fl-d">حسابي</span></a>
        <a class="f-lk" href="#"><i class="ti ti-chevron-left"></i><span id="fl-p">سياسة الخصوصية</span></a>
      </div>
    </div>
    <div>
      <div class="f-ct" id="fct">اتصل بنا</div>
      <div class="fci"><div class="fci-ic"><i class="ti ti-map-pin"></i></div><div><div class="fci-l" id="fcal">العنوان</div><div class="fci-t" id="fca">المملكة العربية السعودية، جده - حي الحمراء-مركز الجمجوم</div></div></div>
      <div class="fci"><div class="fci-ic"><i class="ti ti-phone"></i></div><div><div class="fci-l" id="fcpl">الهاتف</div><div class="fci-t" dir="ltr">+966 504 915 222</div></div></div>
      <div class="fci"><div class="fci-ic"><i class="ti ti-mail"></i></div><div><div class="fci-l" id="fcel">البريد</div><div class="fci-t" dir="ltr">info@amrtm.com.sa</div></div></div>
    </div>
  </div>
  <div class="f-div"></div>
  <div class="f-bot"><div class="f-cp" id="fcp">© 2025 <b>آمر تم</b> — جميع الحقوق محفوظة</div><div class="f-bls"><a class="fbl" href="#" id="fb1">سياسة الخصوصية</a><a class="fbl" href="#" id="fb2">شروط الاستخدام</a><a class="fbl" href="#" id="fb3">تواصل معنا</a></div></div>
</footer>
...
const T = {
    ar: {
       ...
       desc:"منصة موحدة تُنجز خدمات الأفراد وقطاع الأعمال عبر تكامل رقمي آمن وفعّال",
        ...
        desc_emb: "سفارات المملكة والقنصليات والمنظمات",
        ...
        off_ttl: "مكاتب ومنظمات مهنية معتمدة",
        off_sub: "تواصل مباشرةً مع مكاتب محاماة ومكاتب الخدمات والتعقيب وشركات التخليص الجمركي المعتمدة على منصة آمر تم.",
         off_law: "مكاتب المحاماة",
        off_svc: "مكاتب الخدمات والتعقيب",
        off_cus: "شركات التخليص الجمركي",
        off_acc: "مكاتب المحاسبة والاستشارات المالية والضريبية",
        off_eng: "الاستشارات الهندسية والتصميم والإشراف",
        ...
        off_free_desc: "خدمات أصحاب المهن الحرة المعتمدين",off_cnt_lbl: "مكتب معتمد",
    ...
    en: {
       ...
       desc:"A unified platform empowering individuals and businesses with secure, seamless digital services.",
        ...
        off_ttl: "Accredited Professional Offices",
        off_sub: "Connect directly with accredited law firms, service & expediting offices, and customs clearance companies on Amrtm platform.",
...
async function loadOfficeCounts() {
    try {
        ...
        const res  = await fetch(base + '/office-types', { headers: { 'Accept': 'application/json' } });
        if (!res.ok) return;
        const data = await res.json();
        const fmt  = n => n > 0 ? String(n) : '٠';
        const el   = id => document.getElementById(id);
        if (el('off-cnt-law')) el('off-cnt-law').textContent = fmt(data.law || 0);
        if (el('off-cnt-svc')) el('off-cnt-svc').textContent = fmt(data.services || 0);
        if (el('off-cnt-cus')) el('off-cnt-cus').textContent = fmt(data.customs || 0);
        if (el('off-cnt-acc'))
...
function getDemoData() {
    ...
    return [
        ...
        {
            key: "embassies",
            name_ar: " السفارات والقنصليات والمنظمات",
