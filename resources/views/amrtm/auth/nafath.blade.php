...
input:focus{
    ...
    box-shadow:0 0 0 4px rgba(14,138,87,.15);
}
...
<div class="nafath-page">

    <div class="nafath-card">

        <div class="nafath-header">

            <img src="{{ asset('images/nafathLogo.svg') }}" class="nafath-logo">

            <h2>تسجيل الدخول عبر نفاذ</h2>

            <p>
                استخدم هويتك الرقمية للتحقق من هويتك وإكمال عملية تسجيل الدخول بأمان.
            </p>

        </div>

        <form action="{{ route('amrtm.nafath.verify') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    class="@error('national_id') error @enderror"
...
<br>
        ...
        <div class="nafath-note">

            بعد الضغط على <b>متابعة</b> سيتم إرسال طلب التحقق إلى تطبيق
            <b>نفاذ</b> لإكمال عملية تسجيل الدخول.
